...
${TESTDIR}/tests/convertertest.o: tests/convertertest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/convertertest.o tests/convertertest.cpp


${TESTDIR}/tests/convertertestrunner.o: tests/convertertestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/convertertestrunner.o tests/convertertestrunner.cpp
