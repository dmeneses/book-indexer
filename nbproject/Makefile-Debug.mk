...
${TESTDIR}/tests/consoletest.o: tests/consoletest.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/consoletest.o tests/consoletest.cpp


${TESTDIR}/tests/consoletestrunner.o: tests/consoletestrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF $@.d -o ${TESTDIR}/tests/consoletestrunner.o tests/consoletestrunner.cpp
